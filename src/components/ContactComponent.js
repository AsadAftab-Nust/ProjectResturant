            ...
            <div className="container">
                ...
                <div className="row row-content">
                    ...
                    <div className="col-12 col-sm-4 offset-sm-1">
                        <h5>Our Address</h5>
                            <address>
                                Street - 34, Main Markaz <br />
                                Sector F-10<br />
                                Islamabad, Pakistan<br />
                                <i className="fa fa-phone fa-lg"></i>: +923489909857<br />
                                <i className="fa fa-fax fa-lg"></i>: +923489909857<br />
                                <i className="fa fa-envelope fa-lg"></i>: <a href="pakwanresturant@gmail.com">
                                    pakwanresturant@gmail.com</a>
                            </address>
                    </div>
                        ...
                        <Form model="feedback" onSubmit={(values) => this.handleSubmit(values) }>
                            ...
                            <Row className="form-group">
                                <Col md={{ size: 10, offset: 2 }}>
                                    <Button type="submit" className="navbar-dark">Send feedback</Button>
                                </Col>
                            </Row>
